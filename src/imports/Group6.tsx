...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[21px] items-start leading-[normal] left-[52px] not-italic top-[613px] w-[580px]">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex gap-[38px] items-center left-[55px] top-[933px]">
...
function Group() {
  return (
    <div className="absolute contents left-0 top-[560px]">
      <div className="absolute h-[629px] left-0 rounded-bl-[53px] rounded-tl-[53px] rounded-tr-[53px] top-[560px] w-[699px]" data-name="Bacgkround" />
      <Frame2 />
      <Frame1 />
    </div>
  );
...
export default function Group1() {
  return (
    <div className="relative size-full">
      <div className="absolute h-[1189px] left-0 rounded-bl-[53px] rounded-tl-[53px] rounded-tr-[53px] top-0 w-[699px]" data-name="Featured Image">
